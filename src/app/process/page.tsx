...
const steps = [
  ...
  },
  {
    step: "03",
    title: "3D 建模與核對",
    desc: "我們會進行建模或修模。完成後提供三維渲染圖（正面、側面、背面及局部角度）給您核對。我們提供數次免費微調，確保神韻符合期望！",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <QChan
            ...
            text={`第一次訂製公仔，最常擔心的就是「成品會不會像」。放心，在步驟 03【3D建模與核對】時，3D處理人員會提供正面、側面、背面與局部角度讓你確認。\n看過並確認後，我們才會進入列印製作，讓每一步都清楚安心🐾！`}
            position="left"
          />
        </div>
