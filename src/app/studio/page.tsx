    ...
    <div className="w-full py-12 bg-[#F3F4F6] min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="bg-white p-6 rounded-3xl border border-brand-border shadow-sm flex items-center justify-between">
          <div>
            <h1 className="text-xl font-black text-brand-dark">作品案例管理</h1>
        ...
        >
          <h2 className="text-base font-black text-brand-dark">➕ 新增作品案例</h2>
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-extrabold text-brand-dark">案例說明（選填）</label>
            <textarea
              value={desc}
